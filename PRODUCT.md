...
一个人在自己的设备上，从四份自评里选一份来做。

## Product Purpose

把已有的四份自评收成一张目录，点开一张只做这一份。成功是找得到对应的测试并进入它。

## Operating Context

作答留在这台设备上。分数不和另一份相加。结果用于自我了解，不是诊断。
...
题目、计分和各测试页已经在仓库里。卡片图在 `img/`，是为这张目录画的静物，不是照片档案。没有用户证言、价格或机构背书。
